...
<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('manager.store',Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="form-group">
                <label for="">Property Name</label>
                <input type="text" class="form-control" id="" placeholder="Enter " name="property_name">
